...
##
```{r antler1, fig.cap="", echo = FALSE, out.width = "70%", fig.align='center'}
knitr::include_graphics("extra/antler1.jpg")
```

##
```{r antler2, fig.cap="", echo = FALSE, out.width = "50%", fig.align='center'}
knitr::include_graphics("extra/antler2.jpg")
```

##
```{r antler3, fig.cap="", echo = FALSE, out.width = "70%", fig.align='center'}
knitr::include_graphics("extra/antler3.jpg")
```

##
```{r antler4, fig.cap="", echo = FALSE, out.width = "70%", fig.align='center'}
knitr::include_graphics("extra/antler4.jpg")
```
...
##
```{r horns, fig.cap="Horns are found on members of the *Bovidae* family.", echo = FALSE, out.width = "40%", fig.align='center'}
knitr::include_graphics("extra/horns.jpeg")
```
