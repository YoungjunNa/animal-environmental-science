...
In homeotherms, thermoregulatory physiology is mainly controlled by nervous and endocrine systems. If the ambient temperature is going to cold, they generate heat via metabolic processes to keep their body temperature. In contrast, poikilotherms use external sources of temperature to keep their body temperatures (Table \@ref(tab:cooling)). 
