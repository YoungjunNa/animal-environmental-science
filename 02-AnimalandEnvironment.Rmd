...
```{r ext-int-env, fig.cap="External and internal environment", echo = FALSE, out.width = "60%"}
...
Although external environments are continuously changed, if animals in the normal status, they keep the composition of the extracellular fluid (internal environment) constant to maintain their life. We call it *homeostasis*. However, the capacity to maintain the homeostasis is broken when the animals let the harsh environments and differ by their species. **Animals may be limited in their growth and their occurrence by the minimum, maximum, and optimum condition** [@shelford] (Fig. \@ref(fig:law-of-tol)).
