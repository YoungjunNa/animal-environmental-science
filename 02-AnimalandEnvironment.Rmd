...
```{r holdridge, fig.cap="Holdridge life zone classification scheme.", echo = FALSE, out.width = "65%", fig.align='left'}
...
```{r ext-int-env, fig.cap="External and internal environment", echo = FALSE, out.width = "60%", fig.align='left'}
...
```{r law-of-tol, fig.cap="Shelford's law of tolerance", echo=FALSE, message=FALSE, fig.width=6, fig.height=3, fig.align='left'}
library(ggplot2)
library(ggthemes)
