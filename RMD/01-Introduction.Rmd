...
```{r snow-dog, fig.cap="Alaskan Malamute has the heat-conserving features. To retain heat you want the least body surface area compared to body volume.", echo = FALSE, out.width = "100%", fig.align='center'}
