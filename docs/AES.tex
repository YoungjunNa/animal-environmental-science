...
\item
  Manipulating dietary crude protein types and levels.
\item
  Filtration.\\
\item
...
Hydrogen sulfide is a toxic gas and has potential to cause health
...
\tightlist
\item
  Modifying swine diets to balance rations reduce hydrogen sulphide
  emissions.
\item
...
The particulates matter (PM) originate from either the feed, bedding/
manure/litter, or the animal itself (Seedorf and Hartung, 2000).
Particles are globally classified as coarse (\textgreater{}2.5 μm in
diameter) and fine (\textless{}2.5 μm in diameter), with those between
0.50 and 5 μm considered especially damaging to the lungs (Hinds, 1982).
