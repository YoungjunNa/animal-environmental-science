...
\section{4월 29일 수업 관련 공지}\label{-29---}

4월 29일 13:30 부터 17:30까지 양재동 AT센터 5층 그랜드홀에서
\textbf{축산업에대한 오해와 진실}이란 주제로 포럼이 있습니다.
지속가능하고 국민에게 사랑받는 축산을 위해 많은 전문가들이 모여 토론하고
의견을 나누는 자리입니다. 이날은 본 행사에 참석하셔서 공부하는걸로
수업을 대신하도록 하겠습니다. 시간이 되는 분들은 일찍부터 오셔도 좋고,
각자의 수업시간에 맞춰 참석하시면 됩니다. 출석체크는 행사를 마친 이후
로비에서 모여 진행하도록 하겠습니다 :)
